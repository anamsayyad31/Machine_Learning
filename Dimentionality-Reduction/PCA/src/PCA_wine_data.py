# -*- coding: utf-8 -*-
"""
Created on Fri Aug 29 18:31:17 2025
...
df = pd.read_csv('C:/8-PCA,SVD/wine_data_prep.csv')
...
z6 = linkage(pca, method='complete', metric='euclidean')
...
labels6, sil6, db6, ch6 = evaluate_clustering(pca)

# Print results
print("after PCA (5 clusters):")
print(f"  Silhouette Score:        {sil6:.4f}") #0.6001
print(f"  Davies-Bouldin Score:    {db6:.4f}") #0.6557
print(f"  Calinski-Harabasz Score: {ch6:.2f}\n") #508.83
...
score(0.6557):
very good clustering structure.
